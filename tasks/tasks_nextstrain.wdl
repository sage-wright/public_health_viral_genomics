...
task prep_augur_metadata {
  ...
  command {
    ...
    echo -e "strain\tvirus\tdate\tregion\tcountry\tdivision\tlocation\tpango_lineage\t${extra_field1_title}\t${extra_field2_title}\t${extra_field3_title}" > augur_metadata.tsv
